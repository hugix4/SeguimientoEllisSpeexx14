...
<div id="wrapper"><!-- Aquí se envuelve todo el contenido de la página -->
	<section id="main"><!-- contenido principal y menus laterales -->				        		
		<?php    
			...
			$clave=$_POST['clave'];*/
			$query = "update GruposP set Utilizo='$util', Contribuyo='$contri', Agrado='$agrado', Problema='$problem', Observaciones='$obs', Completo='Si' where Nombre = '$nombre' AND Contraseña='$clave' AND Unidad='L2P'"; 
