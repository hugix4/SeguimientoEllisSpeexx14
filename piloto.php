...
<tr>
	<td colspan="2" align="center"
		...
		bgcolor=red><span style="color:fff"><b><br/>Datos incorrectos<br/>Intente nuevamente</b></span>
			<?php }else{?>
				bgcolor=#cccccc></br></br><b>Introduce tu clave de acceso<b/>
			<?php } ?></td>
		</tr><br><br>
				
		<tr>
			<td align="right">Nombre:</td>
			<td><input type="text" name="Nombre" size="8" maxlength="50"></td>
		</tr><br><br>
		<tr>
