...
<area alt="Coordinaci&oacute;n General de Lenguas" shape="rect" coords="550,0,1300,120" href="http://www.cgl.unam.mx">
	...
	<div id="menu">			
					<ul class="menu">
						</br><b style="color: #000066;">Grupos Piloto</b>										
					</ul>
	</div>
...
<div id="wrapper"><!-- Aquí se envuelve todo el contenido de la página -->
	<section id="main"><!-- contenido principal y menus laterales -->				        		
		<?php    
			...
			$nombre=$_POST['nombre'];			
			$clave=$_POST['clave'];			
			$query = "update GruposP set Utilizo='$util', Contribuyo='$contri', Agrado='$agrado', Problema='$problem', Observaciones='$obs', Completo='Si' where Nombre = '$nombre' AND Contraseña='$clave' AND ClaveUnity='$unity'"; 
